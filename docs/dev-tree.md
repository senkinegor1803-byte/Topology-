...
flowchart TD
    ...
    subgraph E1["Этап 1 — MVP 500 м"]
        ...
        S13["1.3 API/очередь"]:::notstarted
...
| --- | --- | --- |
| CI (lint + тесты) | ✅ | `.github/workflows/ci.yml` — ruff + pytest (77 тестов, включая интеграционные с сервисом PostGIS + osm2pgsql) + `docker compose config` на каждый push/PR. |
