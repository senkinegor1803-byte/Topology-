...
| --- | --- | --- |
| CI (lint + тесты) | ✅ | `.github/workflows/ci.yml` — ruff + pytest (189 тестов, включая интеграционные с сервисами PostGIS + Redis, osm2pgsql, реальный Celery-воркер) + `docker compose config` на каждый push/PR. |
